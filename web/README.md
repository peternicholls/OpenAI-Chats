...
- Transcript cleanup for stripped citation/file placeholder noise plus assistant-only reasoning disclosures.
- Attachment images render uncropped at a fixed height inside the standard message bubble, and consecutive image attachments are grouped inline.
