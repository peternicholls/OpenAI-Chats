...
class ExcelExporter(BaseExporter):
    ...
    def export_bytes(self, conversation: dict, messages: List[dict]) -> bytes:
        ...
        # Role colors
        role_fills = {
            "user": PatternFill(start_color="E2EFDA", end_color="E2EFDA", fill_type="solid"),
            "assistant": PatternFill(start_color="DAEEF3", end_color="DAEEF3", fill_type="solid"),
            "system": PatternFill(start_color="FFF2CC", end_color="FFF2CC", fill_type="solid"),
            "tool": PatternFill(start_color="FCE4D6", end_color="FCE4D6", fill_type="solid"),
        }
